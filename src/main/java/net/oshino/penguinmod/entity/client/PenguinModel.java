...
public class PenguinModel<T extends PenguinEntities> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData base = modelPartData.addChild("base", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, 24.0F, 3.0F));

        ModelPartData lower_body = base.addChild("lower_body", ModelPartBuilder.create(), ModelTransform.pivot(-1.0F, 0.0F, -3.0F));
        ...
        ModelPartData upper_body = base.addChild("upper_body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -4.0F, 0.0F));
        ...
        ModelPartData right_flipper = flippers.addChild("right_flipper", ModelPartBuilder.create(), ModelTransform.of(-2.5F, -7.5F, 4.0F, 0.0F, 0.0F, -1.5708F));

        ModelPartData cube_r1 = right_flipper.addChild("cube_r1", ModelPartBuilder.create().uv(12, 20).cuboid(-0.5F, -3.5F, -2.5F, 1.0F, 7.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(-3.0F, 0.0F, -0.5F, 0.0F, 0.0F, 1.5708F));
...
//        this.updateAnimation(entity.idleState, PenguinAnimation.CHECKING, ageInTicks, 1f); // Adds idle animation
